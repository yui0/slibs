/* Simple, Minimalistic, ADPCM library
 *	©2017 Yuichiro Nakada
 *
 * Latest revisions:
 * 	1.00 (11-03-2017) initial release
 *
 * Basic usage:
 *	AUDIO a;
...
void ADPCM_encode(int* sprev, int* sindex, s16* input, int numSamples, u8* output)
{
...
void ADPCM_decode(int* sprev, int* sindex, u8* input, int numSamples, s16* output)
{
